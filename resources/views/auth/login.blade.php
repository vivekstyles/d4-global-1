                            ...
                            <div class="card-body p-4 p-lg-5 text-black">
                                ...
                                <form method="POST" action="/validate">
                                    ...
                                    <div class="d-flex align-items-center mb-3 pb-1">
                                        ...
                                        <span class="h1 fw-bold mb-0">D4 Global</span>
                                    </div>
                                    ...
                                    <div class="pt-1 mb-4">
                                        <button class="btn btn-dark btn-lg btn-block" type="button" onclick="handleSubmit()">Login</button>
                                    </div>
...
<script type="text/javascript" src="{{ URL::asset('js/auth/login.js') }}"></script>
</main>
</body>
